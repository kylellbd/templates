...
jQuery(document).ready(function() {
    ...
    $("#trade_type_1").on("click", function() {
        $("#trade_type_1").attr("class", "btn green btn-outline active");
        $("#trade_type_2").attr("class", "btn green btn-outline ");
        $("#trade_title_1").html("지정가(일반거래)");
        $("#trade_title_2").html("시장가(일반거래)");
    });
    $("#trade_type_2").on("click", function() {
        $("#trade_type_2").attr("class", "btn green btn-outline active");
        $("#trade_type_1").attr("class", "btn green btn-outline ");
        $("#trade_title_1").html("지정가(공매매)");
        $("#trade_title_2").html("시장가(공매매)");
    });
